...
console.log(`Học viên nam có điểm cao nhất là ${findMaleWithHighestGrade(grades).name} với ${findMaleWithHighestGrade(grades).grade} điểm.`);
...
console.log(`Học viên nữ có điểm cao nhất là ${findFemaleWithHighestGrade(grades).name} với ${findFemaleWithHighestGrade(grades).grade} điểm.`);
...
console.log(`Học viên nam có điểm thấp nhất là ${findMaleWithLowestGrade(grades).name} với ${findMaleWithLowestGrade(grades).grade} điểm`);
...
console.log(`Học viên nữ có điểm thấp nhất là ${findFemaleWithLowestGrade(grades).name} với ${findFemaleWithLowestGrade(grades).grade} điểm.`);
...
console.log(`Học viên có điểm cao nhất là ${findMaxGrade(grades).name} với ${findMaxGrade(grades).grade} điểm.`);
...
console.log(`Học viên có điểm thấp nhất là ${findMinGrade(grades).name} với ${findMinGrade(grades).grade} điểm.`);
  
// Bai 10: Lọc danh sách các học viên nữ
const getAllFemales = (grades) => grades.filter((student) => student.sex === 'F');
...
const getFemalesWithNameStartingWithJ = (grades) => {
    return grades.filter((student) => student.sex === 'F' && student.name.startsWith('J')); //dùng filter lọc mảng grades thỏa mãn các điều kiện học viên là nữ có tên bắt đầu bằng 'J'
};
